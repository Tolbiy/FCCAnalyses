...
processList_test = {
    'p8_ee_Zbb_ecm91':{'chunks':1, 'fraction':1e-4},
...
outputDirEos   = "/eos/experiment/fcc/ee/analyses_storage/flavor/Bs2TauTau/flatNtuples/winter2023/analysis_stage1_Leptons_withCuts_ExclBkgSurvey"
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            df
               ...
               #Stage 1 lepton cuts
               .Filter("n_lepton > 1 && has_dilepton > 0 && has_dilepton_SameSide > 0 && has_dilepton_SigHemi > 0 && has_dilepton_OppositeCharges > 0 && has_dilepton_Vertex == 0")
               ...
               .Define("MC_dilepton_CADaughters_ind_reduced","FCCAnalyses::ZHfunctions::Decay_Chain(MC_dilepton_CADaughters_ind)")
               .Define("MC_dileptonplus_Family","FCCAnalyses::ZHfunctions::Find_MuSubdecays(MC_dilepton_CADaughters_ind_reduced,MC_PDG,+1)")
               .Define("MC_dileptonminus_Family","FCCAnalyses::ZHfunctions::Find_MuSubdecays(MC_dilepton_CADaughters_ind_reduced,MC_PDG,-1)")
               .Define("MC_dilepton_BkgCat","10*FCCAnalyses::ZHfunctions::Find_Categories(MC_dileptonplus_Family) + FCCAnalyses::ZHfunctions::Find_Categories(MC_dileptonminus_Family)")
    ...
    def output():
        branchList = [
                ...
                "Vertex_sighemi_ind","Vertex_sighemi_RECO_PDG","Vertex_sighemi_RECO_charge","Vertex_sighemi_RECO_energy",
                "Vertex_sighemi_RECO_px","Vertex_sighemi_RECO_py","Vertex_sighemi_RECO_pz","Vertex_sighemi_RECO_p",
                ...
                "recoEmiss_thrustangle","recoEmiss_e","EVT_Thrust_Mag","EVT_Thrust_X","EVT_Thrust_Y","EVT_Thrust_Z",
