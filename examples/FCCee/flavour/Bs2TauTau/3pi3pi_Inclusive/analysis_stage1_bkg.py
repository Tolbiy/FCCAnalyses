...
outputDirEos   = "/eos/experiment/fcc/ee/analyses_storage/flavor/Bs2TauTau/flatNtuples/winter2023/analysis_stage1_3pi3pi_Inclusive_withCuts"
    ...
    def analysers(df):
        df2 = (
            df
               ...
               #############################################
               #IF SIGNAL => FILTER
               #.Filter("n_genBs2TauTau_Tauminus_3pi > 0 && n_genBs2TauTau_Tauplus_3pi > 0") 
