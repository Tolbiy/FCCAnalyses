...
outputDirEos   = "/eos/experiment/fcc/ee/analyses_storage/flavor/Bs2TauTau/flatNtuples/winter2023/analysis_stage1_ellell_withCuts"
...
class RDFanalysis():
    ...
    def analysers(df):
        df2 = (
            df
               ...
               #############################################
               #IF SIGNAL => FILTER
               .Filter("n_genBs2TauTau_Tauminus_ell > 0 && n_genBs2TauTau_Tauplus_ell > 0") 
               ...
               .Define("EVT_ThrustEmin_pz",        "EVT_thrusthemis1_p.at(2)")
                ...
                #stage 1 evt-level cuts
               .Filter("EVT_ThrustEmin_E < 38 && recoEmiss_e > 10 && EVT_ThrustEmin_Eneutral < 10")
               ...
               .Define("Vertex_sighemi_mass","Vertex_mass_pre [Vertex_thrusthemis_emin>0]")
               .Define("Vertex_sighemi_npart","Vertex_ntrk_pre [Vertex_thrusthemis_emin>0]")
               .Define("Vertex_sighemi_x","Vertex_x_pre [Vertex_thrusthemis_emin>0]")
               .Define("Vertex_sighemi_y","Vertex_y_pre [Vertex_thrusthemis_emin>0]")
               .Define("Vertex_sighemi_z","Vertex_z_pre [Vertex_thrusthemis_emin>0]")
               ...
               .Define("ell_OpeningAngle","FCCAnalyses::ZHfunctions::Leptons_ComputeOpeningAngle(ell_px,ell_py,ell_pz)")
               .Define("dilepton_ind", "FCCAnalyses::ZHfunctions::Leptons_ID_SmallestOA(ell_OpeningAngle,n_ell)")
               .Define("dilepton_plus_ind","FCCAnalyses::ZHfunctions::Find_dileptonq_ind(dilepton_ind,ell_charge,1)")
               .Define("dilepton_minus_ind","FCCAnalyses::ZHfunctions::Find_dileptonq_ind(dilepton_ind,ell_charge,-1)")
               .Define("dilepton_case","FCCAnalyses::ZHfunctions::Find_dilepton_decayCase(dilepton_ind,ell_charge,Lepton0,Muon0)")
               ...
               .Define("has_dilepton_SameSide","FCCAnalyses::ZHfunctions::Check_dilepton_SameSide(ell_OpeningAngle,has_dilepton)")
               .Define("has_dilepton_SigHemi","FCCAnalyses::ZHfunctions::Check_dilepton_SigHemi(dilepton_ind, ell_thrustangles,has_dilepton)")
               .Define("has_dilepton_OppositeCharges","FCCAnalyses::ZHfunctions::Check_dilepton_Charges(dilepton_ind, ell_charge,has_dilepton)")
               .Define("has_dilepton_Vertex","FCCAnalyses::ZHfunctions::Check_dilepton_Vertices(dilepton_ind,Lepton0,ell_charge,VertexObject,has_dilepton)")

               #Stage 1 candidates selections
               .Filter("n_ell > 1 && has_dilepton > 0 && has_dilepton_SameSide > 0 && has_dilepton_SigHemi > 0 && has_dilepton_OppositeCharges > 0 && has_dilepton_Vertex == 0")
    ...
    def output():
        branchList = [
                ...
                "n_ell","ell_px","ell_py","ell_pz","ell_phi","ell_eta","ell_d0","ell_z0","ell_energy","ell_mass",
                "ell_charge","ell_PDG","ell_thrustangles","ell_thrustEmin_n","ell_thrustEmax_n","ell_OpeningAngle","dilepton_ind","dilepton_plus_ind","dilepton_minus_ind","dilepton_case",
